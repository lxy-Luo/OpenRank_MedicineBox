 ...
 */
@RestController("MessageControllerPC")
...
//    @Operation(summary = "删除一条记录",description = "消息ID")
    ...
    public R getMessageByUserId(@PathVariable Integer userId,@PathVariable Integer page){
        return  messageService.getListByUserId(userId,page);
    }
}
