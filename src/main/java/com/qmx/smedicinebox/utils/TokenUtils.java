...
public class TokenUtils {
    ...
    private static PCUserService staticPCUserService;
    ...
    public void setUserService() {
        ...
        staticPCUserService=pcUserService;
    }
    ...
    public static String createToken(String data, String sign) {
        return JWT.create().withAudience(data) // 将 userId-role 保存到 token 里面,作为载荷
                .withExpiresAt(DateUtil.offsetMinute(new Date(), 60)) // 半小时后token过期
        ...
        try {
            ...
            if (ObjectUtil.isNotEmpty(token)) {
                ...
                if (RoleEnum.ADMIN.name().equals(role)) {
                    ...
                    return staticPCUserService.selectById(Integer.valueOf(userId));
                }
            }
        } catch (Exception e) {
