<template>
    <div>
        <div class="search">
            <el-input placeholder="请输入用户名查询" style="width: 200px" v-model="mName"></el-input>
            ...
            <el-table :data="tableData" stripe @selection-change="handleSelectionChange">
                ...
                <el-table-column label="操作" width="180" align="center">
                    <template v-slot="scope">
                        ...
                        <el-button plain type="danger" size="mini" @click=del(scope.row.mid)>删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
            <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
                <el-form-item prop="mname" label="药品名">
                    <el-input v-model="form.mname" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item prop="mdesc" label="介绍">
                    <el-input v-model="form.mdesc" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item prop="mcname" label="药品类别">
                    <el-input v-model="form.mcname" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item prop="mmanufacturer" label="制药公司">
                    <el-input v-model="form.mmanufacturer" autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
...
<script>
import { addMedicine, deleteBatch, deleteMedicineById, getAllMedicine, updateMedicine } from '@/api/medicine';
    ...
    data() {
        return {
            ...
            rules: {
                ...
                mmanufacturer: [
                    { required: true, message: '请输入制药公司', trigger: 'blur' },
                ]
            },
            ids: []
        }
