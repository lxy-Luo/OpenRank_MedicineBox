...
<template>
  <div style="width: 1430px">
    <div class="search" style="width: 1450px">
    ...
    <div class="operation" style="width: 1450px">
      <el-button type="primary" plain @click="handleAdd">新增</el-button>
      <el-button type="danger" plain @click="delBatch">批量删除</el-button>
    </div>

    <div class="table"  style="width: 1450px">
      ...
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="头像">
          <el-upload
              ...
              :action="'http://47.98.255.137:9090' + '/files/uploadOSS'"
...
<!--          单选框-->
        ...
        <el-form-item label="设备id" prop="device">
          <el-date-picker value-format="yyyy-MM-dd" format="yyyy-MM-dd" v-model="form.device" style="width: 100%"></el-date-picker>
        </el-form-item>
      </el-form>
